...
st.markdown("""
    <button class="open-btn" id="guidance-btn">Guidance</button>
    <div id="sidebar" class="sidebar">
        <h1>Treasury & Investment Analysis User Guidance</h1>
        <h2>Step-by-Step Guide</h2>
        <ul>
            <li>Click 'Guidance' button to open this sidebar</li>
            <li>Ensure internet connection is active</li>
            <li>Prepare a CSV file with 'Date', 'Inflow', and 'Outflow' columns</li>
            <li>Find 'Upload Cash Flow Data (CSV)' section on homepage</li>
            <li>Click 'Choose File' to select your CSV</li>
            <li>Submit by clicking upload area or pressing 'Enter'</li>
            <li>Select 'Use Sample Data' checkbox if no CSV is ready</li>
            <li>Check 'Detected Columns' list after upload</li>
            <li>Pick 'Date Column' from dropdown menu</li>
            <li>Choose 'Inflow Column' from dropdown menu</li>
            <li>Select 'Outflow Column' from dropdown menu</li>
            <li>Verify 'Standardized Data' table for correct mappings</li>
            <li>Adjust 'Forecast Periods (Months)' slider (1-24 months)</li>
            <li>Set 'Growth Rate' slider (0.0-0.1)</li>
            <li>Check 'Use Current 10-Year Treasury Yield' or set 'Discount Rate' slider (0.05-0.15)</li>
            <li>Enter 'Initial Investment' in number input</li>
            ...
            <li>Click anywhere outside sidebar to close it</li>
        </ul>
    </div>
    <style>
        body { font-family: Arial, sans-serif; margin: 0; background-color: #000; }
        .sidebar {
            height: 100%;
            width: 0;
            position: fixed;
        ...
        .sidebar h1 { color: #2c3e50; text-align: center; }
        .sidebar h2 { color: #34495e; margin-left: 20px; }
        .sidebar ul { list-style-type: none; padding-left: 20px; }
        .sidebar li { margin-bottom: 10px; }
        .open-btn { padding: 10px 20px; background-color: #3498db; color: white; border: none; cursor: pointer; position: absolute; top: 10px; right: 10px; }
        .open-btn:hover { background-color: #2980b9; }
    </style>
    <script>
